...
def deregister_service_endpoint(service_endpoints_id):  # noqa: E501
    ...
    #     service_endpoints_id = TypesServiceEndpointsId.from_dict(connexion.request.get_json())
...
def register_service_endpoints(body=None):  # noqa: E501
    ...
    """
    # if connexion.request.is_json:
    #     body = [ResourcesEdgeHostedService.from_dict(d) for d in connexion.request.get_json()]  
